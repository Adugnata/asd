...
public class Application {
    public static void main(String[] args) {
        ...
        for (Account account : accountService.getAllAccounts()) {
            ...
            System.out.println("Statement for domain.Account: " + account.getAccountNumber());
            System.out.println("domain.Account Holder: " + customer.getName());
            System.out.println("domain.Account Type: " + account.getInterestStrategy().toString());
